...
router.patch('/:id/status', requireRole([UserRole.SUPPORT_AGENT, UserRole.ADMIN, UserRole.USER]), validateUpdateStatus, TicketController.updateTicketStatus);
router.patch('/:id/rca', requireRole([UserRole.SUPPORT_AGENT, UserRole.ADMIN]), validateUpdateRca, TicketController.updateTicketRca);
router.patch('/:id/outage', requireRole([UserRole.SUPPORT_AGENT, UserRole.ADMIN]), validateUpdateOutage, TicketController.updateOutageDetails);
router.post('/:id/reassign', requireRole([UserRole.ADMIN]), validateReassign, TicketController.reassignTicket);
router.patch('/:id/reply-status', requireRole([UserRole.SUPPORT_AGENT, UserRole.ADMIN]), validateToggleReply, TicketController.toggleCustomerReply);
router.post('/:id/rate', requireRole([UserRole.USER]), validateRateTicket, TicketController.rateTicket);
