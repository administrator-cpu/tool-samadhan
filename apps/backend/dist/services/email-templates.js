...
export const welcomeStaffTemplate = ({ name, email, password, role }) => ({
    ...
    html: emeraldLayout("Support Team Onboarding", `
...
export const welcomeCustomerTemplate = ({ name, email, password }) => ({
    ...
    html: emeraldLayout("Account Created", `
      <p>Dear Customer,</p>
...
export const ticketCreatedTemplate = ({ ticketNo }) => ({
    ...
    html: emeraldLayout("Complaint Registered", `
      <p>Dear Customer,</p>
...
export const ticketCreatedHelpdeskTemplate = ({ customerName, ticketNo, category, circuitId }) => ({
    ...
    html: emeraldLayout("New Ticket Registered", `
      <p>Dear Team,</p>
...
export const ticketAssignedCustomer2MinTemplate = ({ ticketNo }) => ({
    subject: `Fab5: Update regarding your Ticket ID - ${ticketNo}`,
    html: emeraldLayout("Complaint Under Process", `
      <p>Dear Customer,</p>
...
export const ticketAssignedToAgentTemplate = ({ ticketNo, customerName, agentName, category, circuitId }) => ({
    ...
    html: emeraldLayout("Ticket Assigned", `
      <p>Dear Team,</p>
...
export const ticketTroubleshootingCustomer15MinTemplate = ({ ticketNo }) => ({
    subject: `Fab5: Update regarding your Ticket ID - ${ticketNo}`,
    html: emeraldLayout("Troubleshooting in Progress", `
      <p>Dear Customer,</p>
...
export const ticketResolvedTemplate = ({ ticketNo }) => ({
    ...
    html: emeraldLayout("Complaint Resolved", `
      <p>Dear Customer,</p>
...
export const ticketRcaTemplate = ({ ticketNo, rca }) => ({
    ...
    html: emeraldLayout("Root Cause Analysis Update", `
      <p>Dear Customer,</p>
...
export const ticketUpdateByStaffTemplate = ({ ticketNo, agentName, message }) => ({
    subject: `Fab5: Update regarding your Ticket ID - ${ticketNo}`,
    html: emeraldLayout("New Message Received", `
      <p>Dear Customer,</p>
...
export const passwordResetOtpTemplate = ({ name, otpCode }) => ({
    ...
    html: emeraldLayout("Password Recovery", `
      <p>Dear Customer,</p>
...
export const ticketStatusUpdateTemplate = ({ ticketNo, status, updateType }) => {
    ...
    return {
        ...
        html: emeraldLayout(config.title, `
        <p>Dear Customer,</p>
        <p>${config.message}</p>
...
export const longDelayUpdateTemplate = ({ ticketNo }) => ({
    subject: `Fab5: Update regarding your Ticket ID - ${ticketNo}`,
    html: emeraldLayout("Media Outage", `
      <p>Dear Customer,</p>
