          ...
          <div className="flex items-center justify-between px-4 pb-2 pt-2 border-t border-slate-50">
            <div className="flex items-center gap-4">
              ...
              <button 
                 ...
                 className="flex items-center gap-1.5 text-xs font-bold text-slate-600 hover:text-primary disabled:opacity-50"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-brand-gradient px-6 py-2.5 text-sm font-black text-white hover:bg-brand-gradient-hover transition-all disabled:opacity-50"
              >
