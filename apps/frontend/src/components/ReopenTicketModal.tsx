      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-[1rem] bg-white shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50/50 px-6 py-4">
          ...
          <button
            ...
            className="flex h-10 items-center justify-center gap-2 rounded-lg bg-brand-gradient px-6 text-sm font-bold text-white shadow-lg shadow-orange-500/20 transition-all hover:-translate-y-0.5 hover:bg-brand-gradient-hover active:scale-95 disabled:pointer-events-none disabled:opacity-50"
          >
            {isSubmitting ? (
