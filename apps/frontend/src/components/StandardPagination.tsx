        ...
        >
          ...
          {visiblePages.map((p) => (
            <button
              ...
              currentPage === p
                ? 'z-10 bg-brand-gradient hover:bg-brand-gradient-hover text-white border-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
