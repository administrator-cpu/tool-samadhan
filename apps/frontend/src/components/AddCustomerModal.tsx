        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 font-mono tracking-widest focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all outline-hidden"
            />
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-brand-gradient py-4 text-sm font-bold text-white shadow-lg shadow-orange-500/20 transition-all hover:-translate-y-0.5 hover:bg-brand-gradient-hover disabled:opacity-50 disabled:translate-y-0"
            >
