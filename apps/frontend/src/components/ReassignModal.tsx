        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 focus:border-primary focus:ring-1 focus:ring-primary/20 outline-hidden"
            >
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 rounded-lg bg-brand-gradient py-3 text-sm font-bold text-white shadow-lg hover:opacity-90 disabled:opacity-50"
            >
