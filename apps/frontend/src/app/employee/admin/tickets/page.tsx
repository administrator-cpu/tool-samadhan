            ...
            <div className="flex h-12 items-center rounded-lg border border-slate-200 bg-white px-2 py-1 gap-1">
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-2 rounded-md px-4 py-2 text-xs font-bold transition-all ${statusFilter !== "ALL" ? "bg-primary text-white shadow-lg" : "text-slate-500 hover:bg-slate-50"}`}
                >
                  <Filter size={14} />
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-md px-4 py-2 text-xs font-bold transition-all ${sortField === "date" ? "bg-primary text-white shadow-lg" : "text-slate-500 hover:bg-slate-50"}`}
              >
                <Calendar size={14} />
                Date
                ...
                <tbody className="divide-y divide-slate-50">
                  {filteredAndSortedTickets.map((ticket) => (
                    <tr key={ticket.id} className="group transition-all hover:bg-slate-50/80">
                      <td className="px-4 py-6 font-bold text-sm text-primary min-w-[120px] break-words whitespace-normal">
                        {ticket.ticket_no}
                      </td>
