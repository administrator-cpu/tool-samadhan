    ...
    <div className="mx-auto flex max-w-350 flex-col gap-10 px-6 py-10 md:px-12 md:py-14">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex h-12 items-center justify-center rounded-lg bg-brand-gradient px-8 text-sm font-bold tracking-wide text-white shadow-md transition-all hover:-translate-y-0.5 hover:opacity-90"
        >
          Add Staff
        </button>
      </div>
                    ...
                    <td className="px-2 py-4">
                      <div className="flex flex-wrap gap-1 max-w-sm">
                        {emp.categories.map((cat) => (
                          <span key={cat.id} className="inline-flex rounded-md bg-[#F5821F]/10 px-2 py-1 text-[10px] font-bold text-primary uppercase border border-primary/20 mb-1 mr-1">
                            {cat.name}
                          </span>
                        ))}
