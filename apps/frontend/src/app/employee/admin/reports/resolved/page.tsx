      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-30">
        <div className="max-w-(--break-2xl) mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-2xl bg-brand-gradient flex items-center justify-center text-white shadow-lg ">
              <History size={24} />
            </div>
            <div>
                      ...
                      <td className="px-2 py-5 max-w-70">
                        <div className="flex flex-col gap-2">
                          ...
                          <button
                            ...
                            className="text-[10px] font-black text-primary hover:opacity-80 uppercase tracking-widest flex items-center gap-1 w-fit"
                          >
                            <Eye size={12} />
                            View More
                          </button>
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl shadow-slate-900/20 overflow-hidden animate-in fade-in zoom-in duration-300">
            <div className="p-8 sm:p-10">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  <div className="h-14 w-14 rounded-2xl bg-[#F5821F]/10 flex items-center justify-center text-primary">
                    <ShieldCheck size={28} />
                  </div>
                  <div>
                    <h2 className="text-xl font-black text-slate-900 tracking-tight">Root Cause Analysis</h2>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[10px] font-black bg-[#F5821F]/10 text-primary px-2 py-0.5 rounded uppercase tracking-widest border border-primary/20">Verified</span>
            ...
            <div className="p-8">
              ...
              <div className="mt-8 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-lg bg-brand-gradient text-white text-sm font-black hover:opacity-90 transition-all shadow flex items-center gap-2"
                >
                  <Download size={16} />
                  Download CSV
                </button>
