          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex h-12 items-center rounded-lg border border-slate-200 bg-white px-2 py-1 gap-1">
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-md px-4 py-2 text-xs font-bold transition-all ${sortField === "date" ? "bg-primary text-white shadow-lg shadow-ember/20" : "text-slate-500 hover:bg-slate-50"}`}
              >
                <Calendar size={14} />
                Date
                ...
                <tbody className="divide-y divide-slate-50">
                  {filteredAndSortedTickets.map((ticket) => (
                    <tr key={ticket.id} className="group transition-all hover:bg-slate-50/80">
                      <td className="px-4 py-6 font-bold text-sm text-primary">
                        {ticket.ticket_no}
                      </td>
