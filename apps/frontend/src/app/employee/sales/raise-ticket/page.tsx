          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  required
                  className="h-[56px] flex-1 rounded-lg border border-slate-200 bg-white px-4 text-base text-slate-900 placeholder:text-slate-400 transition-shadow focus:border-primary focus:outline-hidden focus:ring-4 focus:ring-primary/10 font-medium"
                />
                <button
                  type="button"
                  onClick={handleVerifyEmail}
                  disabled={fetchingConnections || !formData.customerEmail.trim()}
                  className="h-[56px] px-6 rounded-lg bg-brand-gradient text-white font-bold shadow-md hover:bg-brand-gradient-hover disabled:opacity-50 disabled:cursor-not-allowed transition-all whitespace-nowrap"
                >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="h-[56px] w-full rounded-lg border border-slate-200 bg-white px-4 text-base text-slate-900 placeholder:text-slate-400 transition-shadow focus:border-primary focus:outline-hidden focus:ring-4 focus:ring-primary/10 font-medium"
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                required
                className="h-[56px] w-full rounded-lg border border-slate-200 bg-white px-4 text-base text-slate-900 transition-shadow cursor-pointer focus:border-primary focus:outline-hidden focus:ring-4 focus:ring-primary/10 font-medium disabled:bg-slate-50 disabled:text-slate-400 disabled:cursor-not-allowed"
              >
                {!emailVerified ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                onChange={handleChange}
                className="h-[56px] w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-base text-slate-900 transition-shadow cursor-pointer focus:border-primary focus:outline-hidden focus:ring-4 focus:ring-primary/10 font-medium"
              >
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="h-40 w-full resize-none rounded-lg border border-slate-200 bg-white p-4 text-base text-slate-900 placeholder:text-slate-400 transition-shadow focus:border-primary focus:outline-hidden focus:ring-4 focus:ring-primary/10 font-medium"
              />
            </div>
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={loading}
                className="flex h-[56px] w-full items-center justify-center gap-2 rounded-xl bg-brand-gradient text-white text-[15px] font-bold transition-all hover:bg-brand-gradient-hover disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-orange-500/20"
              >
                {loading ? (
