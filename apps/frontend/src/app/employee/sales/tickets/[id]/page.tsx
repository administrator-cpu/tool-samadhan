            ...
            if (diffHours <= 24) {
              return (
                <button
                  ...
                  disabled={updating}
                  className="flex items-center gap-2 rounded-xl bg-orange-50 px-4 py-2 text-sm font-bold text-primary hover:bg-orange-100 transition-all disabled:opacity-50"
                >
