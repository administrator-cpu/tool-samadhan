      ...
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-gradient px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-orange-500/20 transition-all hover:bg-brand-gradient-hover hover:-translate-y-0.5"
          >
            <PlusCircle size={18} />
            Raise Ticket
          </Link>
