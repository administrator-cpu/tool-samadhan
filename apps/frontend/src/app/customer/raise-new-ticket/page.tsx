           ...
           <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="h-12 w-full rounded-lg border border-slate-200 bg-white px-4 text-base text-slate-900 placeholder:text-slate-400 transition-shadow focus:border-primary focus:ring-1 focus:ring-primary outline-none focus:outline-none disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="h-40 w-full resize-none rounded-lg border border-slate-200 bg-white p-4 text-base text-slate-900 placeholder:text-slate-400 transition-shadow focus:border-primary focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 outline-none focus:outline-none"
              />
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-brand-gradient text-white text-[15px] font-bold shadow-md transition-all hover:bg-brand-gradient-hover disabled:opacity-50 disabled:cursor-not-allowed enabled:hover:cursor-pointer border-none"
              >
                {loading ? (
